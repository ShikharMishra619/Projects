...
def game():
  ...
  while True:
    ...
    choose = input("Type A or B\n\n")
    if choose == "A" and option_a['follower_count'] >= option_b['follower_count']:
      score += 1
      ...
      option_b = random.choice(data)
    elif choose == "A" and option_a['follower_count'] < option_b['follower_count']:
      print(f"{option_a['name']} has {option_a['follower_count']} followers\n\n")
      print(f"{option_b['name']} has {option_b['follower_count']} followers\n\n")
      print(f"You are wrong\n\nYour final score is {score}\n\n")
      return
    elif choose == "B" and option_a['follower_count'] >= option_b['follower_count']:
      print(f"{option_a['name']} has {option_a['follower_count']} followers\n\n")
      print(f"{option_b['name']} has {option_b['follower_count']} followers\n\n")
      print(f"You are wrong\n\nYour final score is {score}\n\n")
      return
      ...
      option_b = random.choice(data)
print(logo)
user_choice = int(input("Type 1 for NEW GAME\nType 2 to QUIT\n\n"))
if user_choice == 1:
  game()
elif user_choice == 2:
  print("GOODBYE!!!")
